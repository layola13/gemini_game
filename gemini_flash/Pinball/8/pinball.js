...
export class Pinball {
  constructor(canvas, ctx) {
    ...
    this.ballSpeedX = 1.5; // 降低球的速度
    this.ballSpeedY = -1.5; // 降低球的速度
    this.paddleWidth = 150; // 增加球拍的宽度
    ...
    this.paddleHitSound.onerror = () => {
      console.error("球拍击球音效加载失败！");
    };
    this.obstacleHitSound = new Audio('obstacle_hit.wav'); // 障碍物碰撞音效
    this.obstacleHitSound.onerror = () => {
      console.error("障碍物碰撞音效加载失败！");
    };
    this.gameOverSound = new Audio('game_over.wav'); // 游戏结束音效
    this.gameOverSound.onerror = () => {
